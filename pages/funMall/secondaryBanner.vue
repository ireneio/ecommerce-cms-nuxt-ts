<template>
  <div>
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <h2 class="mb-4">副 Banner 管理</h2>
          <v-card outlined>
            <v-toolbar flat>
              <v-btn color="primary" @click="toggleModal = true">
                <v-icon>mdi-plus</v-icon> 新增 Banner
              </v-btn>
                ...
                <v-row>
                  ...
                  <v-col cols="12" class="mt-n5">
                    <v-file-input
                      ...
                      placeholder="點擊上傳"
                      prepend-icon=""
                      hint="格式限制為大小限制 2MB，1170*120px 的 JPG、PNG、GIF"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
                  <v-col cols="12" class="mt-n5">
                    <v-file-input
                      ...
                      placeholder="點擊上傳"
                      prepend-icon=""
                      hint="格式限制為大小限制 2MB，1170*165px 的 JPG、PNG、GIF"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
                </v-row>
...
export default class FunMallSecondaryBanner extends Vue {
  private headers: Array<any> = [
    { text: 'Banner 名稱', value: 'fat', align: 'start', sortable: false },
    {
      text: 'LOGO 圖示',
      value: 'fat',
      align: 'start',
