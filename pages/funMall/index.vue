  ...
  <div>
    ...
    >
      <v-card>
                ...
                <v-row>
                  ...
                  <v-col cols="12" class="mt-n5">
                    <v-file-input
                      ...
                      placeholder="點擊上傳"
                      prepend-icon=""
                      hint="格式限制為大小限制 2MB，1170*390px 的 JPG、PNG、GIF"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
                  <v-col cols="12" class="mt-n5">
        ...
        <v-card-actions style="border-top: 1px solid #eef">
...
export default class FunMallIndex extends Vue {
