              ...
              <v-banner color="rgba(60, 141, 188, 0.05)">
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="3">
                      <v-select :items="items" label="訂單編號"></v-select>
                    </v-col>
                    <v-col cols="3">
      ...
      <v-card>
        ...
        <v-card-text class="mt-4">
          <v-card outlined>
            ...
            <v-card-title>物流單號</v-card-title>
            <v-card-text color="#fff">
              <v-simple-table>
                <template v-slot:default>
                  <thead>
                    <tr>
                      ...
                      <th class="text-left">出貨狀態</th>
                      <th class="text-left">出貨日期</th>
                      <th class="text-left">到貨日期</th>
                      <th class="text-left">宅配公司</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr v-for="item in desserts" :key="item.name">
...
export default class OrderShipping extends Vue {
  private headers: Array<any> = [
    { text: '流水號', value: 'calories', align: 'start', sortable: false },
    {
      text: '訂單編號',
      value: 'fat',
      align: 'start',
    ...
    { text: '貨運編號', value: 'fat', align: 'start', sortable: false },
    { text: '物流單號', value: 'fat', align: 'start', sortable: false },
    { text: '訂單日期', value: 'fat', align: 'start', sortable: false },
    { text: '客戶帳號', value: 'fat', align: 'start', sortable: false },
    { text: '商品名稱', value: 'fat', align: 'start', sortable: false },
    { text: '訂單狀態', value: 'fat', align: 'start', sortable: false },
    { text: '出貨狀態', value: 'fat', align: 'start', sortable: false },
    { text: '出貨日期', value: 'fat', align: 'start', sortable: false },
    { text: '到貨日期', value: 'fat', align: 'start', sortable: false },
