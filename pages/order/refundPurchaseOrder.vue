...
export default class OrderRefundPurchaseOrder extends Vue {
  private headers: Array<any> = [
    { text: '退款單號', value: 'calories', align: 'start', sortable: false },
    ...
    { text: '訂購人姓名', value: 'fat', align: 'start', sortable: false },
    { text: '訂購人電話', value: 'fat', align: 'start', sortable: false },
    { text: '訂購人 Email', value: 'fat', align: 'start', sortable: false },
    { text: '退款總金額', value: 'fat', align: 'start', sortable: false },
    { text: '退刷現金', value: 'fat', align: 'start', sortable: false },
    { text: '退款點數', value: 'fat', align: 'start', sortable: false }
  ]
