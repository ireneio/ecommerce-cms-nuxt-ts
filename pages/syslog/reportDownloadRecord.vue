            ...
            <v-banner color="rgba(60, 141, 188, 0.05)">
              <v-container>
                <v-row>
                  ...
                  <v-col cols="3">
                    <v-select :items="items" label="模組"></v-select>
                  </v-col>
                  <v-col cols="3">
...
export default class SyslogReportDownloadRecord extends Vue {
  private headers: Array<any> = [
    ...
    { text: '模組', value: 'fat', align: 'start', sortable: false },
