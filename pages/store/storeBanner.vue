<template>
  <div>
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <h2 class="mb-4">特約 Banner 管理</h2>
          <v-card outlined>
            <v-toolbar flat>
              <v-btn color="primary" @click="toggleModal = true">
                <v-icon>mdi-plus</v-icon> 新增資料
              </v-btn>
                ...
                <v-row>
                  ...
                  <v-col cols="12" class="mt-n5">
                    <v-file-input
                      ...
                      placeholder="點擊上傳"
                      prepend-icon=""
                      hint="格式限制為大小限制 2MB，建議為 1104*230px 的 JPG、PNG、GIF"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
                  <v-col cols="12" class="mt-n5">
                    <v-file-input
                      ...
                      placeholder="點擊上傳"
                      prepend-icon=""
                      hint="格式限制為大小限制 2MB，建議為 1125*750px 的 JPG、PNG、GIF"
                      persistent-hint
                    ></v-file-input>
                  </v-col>
                  <v-col cols="12" class="mt-n5">
...
export default class StoreStoreBanner extends Vue {
  private headers: Array<any> = [
    { text: '名稱', value: 'calories', align: 'start', sortable: false },
    { text: '圖示', value: 'fat', align: 'start', sortable: false },
