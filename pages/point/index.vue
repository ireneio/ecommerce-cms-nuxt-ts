              ...
              <v-container>
                <v-row>
                  <v-col cols="12" class="mt-n4">
                    <v-select :items="items" label="適用客戶"></v-select>
                  </v-col>
                  <v-col cols="12" class="mt-n4">
                    <v-text-field
                      v-model="model"
...
export default class PointIndex extends Vue {
  private headers: Array<any> = [
    { text: '適用客戶', value: 'calories', align: 'start', sortable: false },
